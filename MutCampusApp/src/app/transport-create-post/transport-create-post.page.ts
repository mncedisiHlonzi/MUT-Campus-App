...
@Component({
  selector: 'app-transport-create-post',
  templateUrl: './transport-create-post.page.html',
  styleUrls: ['./transport-create-post.page.scss'],
})
export class TransportCreatePostPage implements OnInit {
